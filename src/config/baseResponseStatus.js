module.exports = {
    ...
    MYPAGE_SETIDX_EMPTY : {"isSuccess": false, "code":8011, "message":"setIdx(gpt 추천 번호)가 존재하지 않습니다."},
    MYPAGE_QJ_SETIDX_EMPTY : {"isSuccess": false, "code":8012, "message":"해당 번호는 qj(gpt)가 추천해주지 않았습니다."},
